                        ...
                        <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                            ...
                            <div class="hidden sm:ml-6 sm:block">
                                <div class="flex space-x-4">
                                    ...
                                    <a href="#" aria-current="page" class="rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white">QR generating</a>
                                    <a href="#" class="rounded-md px-3 py-2 text-sm font-medium text-gray-800 hover:bg-white/5 hover:text-white">My Qr</a>
                                    {/* <a href="#" class="rounded-md px-3 py-2 text-sm font-medium text-gray-800 hover:bg-white/5 hover:text-white">Projects</a>
                                    <a href="#" class="rounded-md px-3 py-2 text-sm font-medium text-gray-800 hover:bg-white/5 hover:text-white">Calendar</a> */}
                                </div>
                            </div>
                        </div>
